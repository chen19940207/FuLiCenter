...
//        textView.setText("hello ....");
    ...
    class CatFilterAdapter extends BaseAdapter {
        ...
        public View getView(final int i, View view, ViewGroup viewGroup) {
            CatFilterViewHolder cvh = null;
            if (view == null) {
                 view = View.inflate(context, R.layout.item_cat_filter, null);
                cvh = new CatFilterViewHolder(view);
                view.setTag(cvh);
            } else {
                cvh = (CatFilterViewHolder) view.getTag();
            }
           cvh.bind(i);
            return view;
        }
        ...
        class CatFilterViewHolder {
            ...
            public void bind(final int i) {
                ImageLoader.downloadImg(context, mivCategoryChildThumb, list.get(i).getImageUrl());
                mtvCategoryChildName.setText(list.get(i).getName());
                mlayoutCategoryChild.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        MFGT.gotoCategoryChild(mContext,
                                ...
                                groupName,
                                list);
                        MFGT.finishActivity((CategoryChildActivity) mContext);
                    }
                });
            }
        }
